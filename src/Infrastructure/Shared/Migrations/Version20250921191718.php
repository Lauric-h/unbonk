 ...
 */
final class Version20250921191718 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_1881F565113D03C9 ON segment');
        $this->addSql('ALTER TABLE segment CHANGE nutrition_plan_id race_id VARCHAR(255) NOT NULL, CHANGE carbs_target_value position INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE segment CHANGE race_id nutrition_plan_id VARCHAR(255) NOT NULL, CHANGE position carbs_target_value INT NOT NULL');
